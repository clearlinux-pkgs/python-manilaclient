...
Source0  : http://tarballs.openstack.org/python-manilaclient/python-manilaclient-1.24.1.tar.gz
Source99 : http://tarballs.openstack.org/python-manilaclient/python-manilaclient-1.24.1.tar.gz.asc
Summary  : Client library for OpenStack Manila API.
Group    : Development/Tools
License  : Apache-2.0
Requires: python-manilaclient-bin
Requires: python-manilaclient-python3
Requires: python-manilaclient-license
...
%prep
%setup -q -n python-manilaclient-1.24.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1533042528
python3 setup.py build -b py3

%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/python-manilaclient
cp LICENSE %{buildroot}/usr/share/doc/python-manilaclient/LICENSE
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/python-manilaclient/LICENSE
