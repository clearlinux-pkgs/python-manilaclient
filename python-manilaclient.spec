...
Version  : 1.6.0
Release  : 3
URL      : http://tarballs.openstack.org/python-manilaclient/python-manilaclient-1.6.0.tar.gz
Source0  : http://tarballs.openstack.org/python-manilaclient/python-manilaclient-1.6.0.tar.gz
...
%prep
%setup -q -n python-manilaclient-1.6.0
